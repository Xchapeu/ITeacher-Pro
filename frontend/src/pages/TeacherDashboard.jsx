      ...
      <div className="flex min-h-screen">
        ...
        `}>
          ...
          <nav className="space-y-1 lg:space-y-2">
            <Link to="/teacher" data-testid="nav-overview" onClick={() => setSidebarOpen(false)}>
              <Button
                variant="ghost"
              ...
              >
                ...
                <span className="truncate">Minhas Turmas</span>
              </Button>
            </Link>
            <Link to="/teacher/materials" data-testid="nav-materials" onClick={() => setSidebarOpen(false)}>
              <Button
                variant="ghost"
                className={`w-full justify-start gap-3 text-sm lg:text-base ${
            ...
            <Link to="/teacher/messages" data-testid="nav-messages" onClick={() => setSidebarOpen(false)}>
              <Button
                variant="ghost"
                className={`w-full justify-start gap-3 text-sm lg:text-base ${
